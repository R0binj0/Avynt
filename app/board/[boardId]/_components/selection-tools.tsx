...
export const SelectionTools = memo(({
    ...
    return (
        <div className="absolute p-3 rounded-xl bg-[var(--background-light)] text-[var(--text)] shadow-sm border flex select-none" style={{transform: `translate(calc(${x}px - 50%), calc(${y - 16}px - 100%))`}}>
